...
\subsection{solve, Solve.tridiag, Solve.banded}
  ...
  To make the problem matehamtically demanding, the A matrix contains 5000
  rows and 5000 columns, and the problem is solved for 10 different vectors B.
...
<<>>=
Top  <- matrix(nr=2, nc=4, byrow=TRUE,data=
   c( 0.0,  -0.98, -0.79, -0.15, -1.00,  0.25, -0.87,  0.35))
   
Bot  <- matrix(nr=2, nc=4, byrow=TRUE, data =
   c( 0.71, -0.64,   0.0,  0.48,  0.08, 100.0, 50.00, 15.00))
   
Blk1 <- matrix(nr=4, nc=8, byrow=TRUE, data =
   c( 0.78,  0.31, -0.85,  0.89, -0.69, -0.98, -0.76, -0.82,
      0.12, -0.01,  0.75,  0.32, -1.00, -0.53, -0.83, -0.98,
     -0.58,  0.04,  0.87,  0.38, -1.00, -0.21, -0.93, -0.84,
     -0.21, -0.91, -0.09, -0.62, -1.99, -1.12, -1.21,  0.07))
     
Blk2 <- matrix(nr=4, nc=8, byrow=TRUE, data=
