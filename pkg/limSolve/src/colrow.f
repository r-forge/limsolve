     ...
     *         TMP1, TMP2)
        ...
        INTEGER PIVOT(1),nrwtop,NRWBLK,NCLBLK,NRWBOT,N,NOVRLP,NBLOKS
	      INTEGER I, IFLAG, rB, cB
        DIMENSION TOPBLK(NRWTOP,1),ARRAY(NRWBLK,NCLBLK,1),
     *          BOTBLK(NRWBOT,1),B(rB,cB),X(N,cB),TMP1(*),TMP2(*)
...
C
        ...
        INTEGER PIVOT(1),NRWTOP,NRWBLK,NCLBLK,NRWBOT,IFLAG
...
C
        ...
        INTEGER PIVOT(1),NRWTOP,NRWBLK,NCLBLK,NRWBOT
